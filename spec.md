...
23. Tutoriel **par l'action** au premier lancement. Le tutoriel utilise la **barre de statut** (fond jaune pâle `#FEF3C7`, bordure gauche orange `#D97706`) au lieu d'un overlay semi-transparent. L'outil Segment est forcé au démarrage. Le tutoriel avance automatiquement quand l'enfant exécute l'action décrite :
